...
dnl #
dnl define(`SMART_HOST', `fluentd.simalab.com')dnl
dnl #
...
dnl define(`LUSER_RELAY',`smtp:simalab.com')dnl
dnl #
...
######################################################################
## 2016.03.21 AddSection. (Subject: check local rule)
######################################################################
...
######################################################################
## 2016.03.21 AddSection. (From: (heder from) check local rule)
######################################################################
